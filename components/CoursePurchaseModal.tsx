              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-navy-500">
                    {courseLevel === "igcse" ? "IGCSE / O Level" : courseLevel.toUpperCase()} • {courseInstructor}
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="p-4 bg-navy-50 rounded-xl mb-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg font-bold text-navy-800">PKR {courseFee.toLocaleString()}</span>
                </div>
              </div>
